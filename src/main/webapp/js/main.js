$(function () {
    ...
    window.App.plyTemplate = function () {
        ...
        initialize: function () {
            ...
            gameView.fetch({
                success: function (form) {
                    ...
                    context.positionView = new App.Views.Position({model: new App.Models.Position(context.begin.toJSON())});
                }
            });
        },
    ...
    $(document).keydown(function(e) {
        switch(e.which) {
            case 37: // left
                window.draughts_board_demonstration.prevStep();
                break;

            case 39: // right
                window.draughts_board_demonstration.nextStep();
                break;
